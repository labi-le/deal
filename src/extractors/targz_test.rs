#[cfg(test)]
mod tests {
    use super::super::TarGzExtractor;
    ...
    fn create_in_memory_targz(file_name: &str, content: &[u8]) -> Vec<u8> {
    ...
    fn test_targz_extraction() {
        ...
        let file_content = b"hello tar.gz";
        let file_name = "test.txt";

        let buffer = create_in_memory_targz(file_name, file_content);
